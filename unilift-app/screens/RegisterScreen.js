...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    ...
    setLoading(true);
    try {
      // Trim/normalize fields to avoid accidental whitespace/casing issues
      const payload = {
        name: name.trim(),
      ...
      // Log the error for debugging (network/CORS/validation etc.)
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.form}>
          ...
          <TextInput
            style={styles.input}
            placeholder="eg: New Horizon College of Engineering"
            value={college}
